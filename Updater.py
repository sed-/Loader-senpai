    ...
    try:
        ...
        for line in response.text.splitlines():
            if line.startswith("Version:"):
                ...
                print(f"{Fore.LIGHTYELLOW_EX}[DEBUG] Remote version fetched: {remote_version}")  # Debugging output
        ...
        with open("Version.txt", "r") as file:
            for line in file.readlines():
                if line.startswith("Version:"):
                    ...
                    print(f"{Fore.LIGHTYELLOW_EX}[DEBUG] Local version fetched: {local_version}")  # Debugging output
...
def check_version():
    ...
    if remote_version and local_version:
        # Debugging: output the values before comparison
        print(f"{Fore.LIGHTYELLOW_EX}[DEBUG] Comparing versions. Remote: {remote_version}, Local: {local_version}")
